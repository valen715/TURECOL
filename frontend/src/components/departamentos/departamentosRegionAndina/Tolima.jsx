  ...
  return (
    <header>
      <div className="divsito">
        <h1 className="titulo">Tolima</h1>
        <img className="imagenes" src={imagen.img31} width="150" height="100" />
        <p className="text">
          {" "}
        ...
        <br></br>
        <img className="imagenes2" src={imagen.img32} width="150" height="100" />
        <p className="text">
          {" "}
