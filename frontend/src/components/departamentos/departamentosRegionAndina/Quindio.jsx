  ...
  return (
    <header>
      <div className="divsito">
        <h1 className="titulo">Quindio</h1>
        <img className="imagenes" src={imagen.img25} width="150" height="100" />
        <p className="text">
          {" "}
        ...
        <br></br>
        <img className="imagenes2" src={imagen.img26} width="150" height="100" />
        <p className="text">
          {" "}
