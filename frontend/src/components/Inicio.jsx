          ...
          {(logueado && (
            <>
              <div className="container">
                <div className="columna">
                  ...
                  <p className="card-parrafo">
                    ...
                    Venezuela, también tiene límite dentro del país con la
                    región Andina y la región Orinoquía.
                  </p>
                  <a href="/amazonas" className="button-enlace">
                    <button className="button-ver-mas1 button-ver-mas-mensaje1">
                      Ver más
                    </button>
                  </a>
                </div>
                <div className="columna">
                  ...
                  <p className="card-parrafo">
                    ...
                    templado, cuenta con 37.068.593 habitantes, tiene límites
                    geográficos con el país de Venezuela, también tiene límite
                    dentro del país con todas las otras regiones (Amazónica,
                    Orinoquía, Pacífica y Caribe).
                  </p>
                ...
                <div className="columna">
                  ...
                  <p className="card-parrafo">
                    ...
                    límites geográficos con los países de Panamá y Ecuador,
                    dentro del país tiene límite con la región Andina y limita
              ...
              <a href="/ " className="button-cerrar-sesion">
                {" "}
                <button
                  className="button-ver-mas1 button-ver-mas-mensaje1"
